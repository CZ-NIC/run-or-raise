...
export class Action {
  ...
  _focus_next_created_window() {
    let createdHandlerId, attentionHandlerId, timeoutId
    let done = false
    const stop = () => {
      if (done) return
      done = true
      global.display.disconnect(createdHandlerId)
      global.display.disconnect(attentionHandlerId)
      GLib.source_remove(timeoutId)
    }
    createdHandlerId = global.display.connect(
      "window-created",
      (display, window) => {
    ...
    attentionHandlerId = global.display.connect(
